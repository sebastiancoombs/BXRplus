...
export const initialMockTasks: Task[] = [
  ...
  { id: '4', user_id: 'mock', title: 'Project BXR+', task_type: 'normal', parent_id: null, position: 0, is_completed: false, created_at: new Date().toISOString(), completed_at: null, deleted_at: null, color: 'emerald', keep_alive: true, is_collapsed: false, children:[] },
