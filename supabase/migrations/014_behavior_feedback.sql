-- Per-behavior child-facing feedback customization
alter table public.behaviors add column if not exists feedback_theme text;
alter table public.behaviors add column if not exists feedback_intensity text;
alter table public.behaviors add column if not exists feedback_mode text;
